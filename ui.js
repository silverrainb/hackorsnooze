$(async function () {
    ...
    $createAccountForm.on("submit", async function (evt) {
        ...
        console.log("Let's create new User with", name, username, "and password")
        const newUser = await User.signUp(username, password, name)
        console.log("New User has been created. Sign Up Post: ", newUser)
        currentUser = newUser
        syncCurrentUserToLocalStorage()
        loginAndSubmitForm()
    })
     ...
     */
    // Hack or Snooze Anchor tag on top left
    ...
    // Nav bar `login/create user` option disappears
